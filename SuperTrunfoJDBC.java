...
/**
 * Sistema Super Trunfo usando JDBC puro Nível 1 - Novato: Desafio de Código -
 * "Cartas Clássicas - JDBC Puro"
 *
 * Funcionalidades: - Gerenciamento de cartas (alunos) com CRUD completo -
 * Sistema de batalhas entre cartas - Interface de console interativa -
...
public class SuperTrunfoJDBC {
    ...
    public static void criarTabela() {
        String sql = "CREATE TABLE aluno (matricula VARCHAR(10) PRIMARY KEY, nome VARCHAR(50), entrada INTEGER)";
        ...
        try (Connection conn = getConnection(); Statement stmt = conn.createStatement()) {
            ...
            if (e.getSQLState().equals("X0Y32")) {
                System.out.println("✅ Tabela 'aluno' já existente.");
            }
        }
    }
    ...
    public static void inserirDadosExemplo() {
        ...
        Aluno[] exemplos = {
            ...
            new Aluno("B2020002", "Bruno Santos", 2020),
            new Aluno("C2020003", "Carla Oliveira", 2020)
        };
    ...
    public static void batalharCartas() {
        ...
        System.out.println("⚔️  Carta 1:");
        carta1.exibirCarta();
        System.out.println("⚔️  Carta 2:");
        carta2.exibirCarta();

        if (carta1.batalhar(carta2)) {
            System.out.println("✅ Carta 1 venceu a batalha!");
        } else if (carta2.batalhar(carta1)) {
            System.out.println("✅ Carta 2 venceu a batalha!");
        } else {
